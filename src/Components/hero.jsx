...
export default function Hero() {
  return (
    <section id="hero" className="hero-section relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-sky-500/20 rounded-full blur-[120px] -z-10 animate-pulse" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-indigo-500/20 rounded-full blur-[120px] -z-10 animate-pulse delay-1000" />

      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center z-10">
        <div className="hero-content text-left lg:text-left">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-sky-400 font-medium tracking-widest uppercase mb-4 text-sm md:text-base">
            ...
            <h3 id="head" className="text-2xl md:text-4xl text-gray-300 font-light mb-8">
              Software Developer <span className="text-sky-400">|</span> AI Enthusiast
            </h3>

            <div id="tag" className="h-12 text-lg md:text-xl text-gray-400 mb-10">
              <Typewriter
                words={[
        ...
        <div className="hero-model relative h-[400px] md:h-[600px] w-full">
          <Canvas
